//No todos los lcd.c son iguales, aquí le quité TRISC=0 en lcd_init() porque esto impedía la comunicación serial. 
#include<htc.h>
...
void lcd_init(){
	...
	lcd_write(0x28); //Se establece el tama�o de la interfaz.
